...
async function getPollutionData() {
  try {
    const response = await fetch(
      "http://api.airvisual.com/v2/nearest_city?lat={{LATITUDE}}&lon={{LONGITUDE}}&key=526e1e6b-ccaf-44e7-a5c6-72dbd5d27014"
    ).catch((error) => {
...
const locationPointer = document.querySelector(".class-pointer");
